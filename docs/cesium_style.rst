...
+---------------------------+---------------------------------------+
| "rectangle_black.gltf"    | black rectangle                       |
+---------------------------+---------------------------------------+
| "rectangle_white.gltf"    | white rectangle                       | 
+---------------------------+---------------------------------------+
| "rectangle_red.gltf"      | red rectangle                         |
+---------------------------+---------------------------------------+
| "rectangle_green.gltf"    | green rectangle                       |
+---------------------------+---------------------------------------+
| "rectangle_blue.gltf"     | blue rectangle                        |
+---------------------------+---------------------------------------+
| "wedge_black.gltf"        | black wedge                           |
+---------------------------+---------------------------------------+
| "wedge_white.gltf"        | white wedge                           |
+---------------------------+---------------------------------------+
| "wedge_red.gltf"          | red wedge                             |
+---------------------------+---------------------------------------+
| "wedge_green.gltf"        | green wedge                           | 
+---------------------------+---------------------------------------+
| "wedge_blue.gltf"         | blue wedge                            |
+---------------------------+---------------------------------------+
